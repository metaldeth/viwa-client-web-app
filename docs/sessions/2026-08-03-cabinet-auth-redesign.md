...
- Version bumped to **`0.1.26`** in `package.json`.
...
- `npm test` — **PASS**, 153 Vitest tests and 2 Node tests.
- `npm run build` — **PASS**; `dist/version.json` reports `0.1.26`.
...
- Commit and push `0.1.26` on `dev`.
- Deploy `0.1.26` and production smoke (phone → OTP, resend cooldown, mobile widths 320–430px).
